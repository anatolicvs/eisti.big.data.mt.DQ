...
The DQDs must be relevant to the DQ problems as identified In Table 3.1 Therefore DQ Metrics are 
...
For example a metric that calculates the accurancy of a data attribute is defined as follows:
