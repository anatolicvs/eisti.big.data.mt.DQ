...
instant \textit{t}, with $t\in$ $[t\textunderscore pub, t\textunderscore max]$ , where t pub is the initial 
instant of publication of data and $t\textunderscore max$ corresponds to the maximum time within which the
